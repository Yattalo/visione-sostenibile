...
export default function ServiziPage() {
  ...
  return (
    <div className="min-h-screen bg-paper-50">
          ...
          <SlideUp>
            <div className="max-w-2xl mb-16 lg:mb-20">
              ...
              <h2 className="font-display text-3xl md:text-4xl text-forest-950 mt-3 leading-tight">
                ...
                <span className="text-leaf-700">una sola visione</span>
              </h2>
      ...
      ═══════════════════════════════════════════════════ */}
      <section className="relative py-24 lg:py-32 bg-paper-100 overflow-hidden">
          ...
          <SlideUp>
            <div className="text-center mb-16 lg:mb-20">
              ...
              <h2 className="font-display text-3xl md:text-4xl text-forest-950 mt-3 leading-tight">
                ...
                <span className="italic text-leaf-700">eccellenza</span> nel
                risultato
              </h2>
            </div>
          </SlideUp>
              ...
              {[
                ...
                <StaggerItem key={item.step} delay={index * 0.15}>
                  <div className="text-center md:text-left">
                    <span className="font-display text-6xl font-light text-leaf-300">
                      {item.step}
                    </span>
                    <h3 className="font-display text-2xl text-forest-950 mt-2 mb-4">
                      {item.title}
                    </h3>
