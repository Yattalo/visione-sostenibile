    ...
    const projects = [
      {
        ...
        photo_count: 4,
        render_count: 0,
        hero_image: "/progetti/baveno-lago-maggiore/baveno-lago-maggiore_hero.jpg",
        hero_alt: "Baveno – Lago Maggiore – Visione Sostenibile",
        thumbnail: "/progetti/baveno-lago-maggiore/baveno-lago-maggiore_hero_thumb.jpg",
      ...
      },
      {
        ...
        photo_count: 7,
        render_count: 0,
        hero_image: "/progetti/agriturismo-durando-portacomaro/agriturismo-durando-portacomaro_hero.jpg",
        hero_alt: "Agriturismo Durando – Portacomaro – Visione Sostenibile",
        thumbnail: "/progetti/agriturismo-durando-portacomaro/agriturismo-durando-portacomaro_hero_thumb.jpg",
        photos: [] as Array<{ src: string; thumb: string; alt: string; caption: string; type: "hero" | "gallery" | "render"; }>,
        renders: [] as Array<{ src: string; thumb: string; alt: string; caption: string; type: "hero" | "gallery" | "render"; }>,
